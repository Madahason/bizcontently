        ...
        <AnimatePresence mode="popLayout">
          {videos.map((video) => (
            <motion.div
              ...
              exit={{ opacity: 0, y: 20 }}
              className="group cursor-pointer overflow-hidden rounded-lg bg-white shadow-sm transition-all hover:shadow-md dark:bg-gray-800"
              onClick={() => setSelectedVideo(video)}
            >
              {/* Thumbnail */}
              <div className="relative aspect-video overflow-hidden">
                <div className="absolute inset-0 z-10 flex items-center justify-center bg-black bg-opacity-0 transition-all group-hover:bg-opacity-30">
                  <svg
                    className="h-12 w-12 text-white opacity-0 transition-all group-hover:opacity-100"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
